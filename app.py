...
REGION = {"Oeste": GREEN, "Este": BLUE, "Central": RED, "Sur": AMBER}
CAT    = {"Muebles": AMBER, "Útiles de Oficina": BLUE, "Tecnología": GREEN}
...
with col2:
    ...
    st.plotly_chart(fig2, use_container_width=True, config={"displayModeBar": False}, key="h1b")
...
st.plotly_chart(fig3, use_container_width=True, config={"displayModeBar": False}, key="h2")
...
with col3:
    ...
    fig4.update_layout(
        ...
        yaxis_title="Ganancia promedio ($)", yaxis_tickprefix="$",
        yaxis_gridcolor="#f0f0f0", margin=dict(t=60, b=20),
    )
    fig4.add_hline(y=0, line_width=1.5, line_color="#888", line_dash="dash")
    st.plotly_chart(fig4, use_container_width=True, config={"displayModeBar": False}, key="h3a")
...
with col4:
    ...
    fig5.update_layout(
        plot_bgcolor="white",
        xaxis_title="Descuento aplicado", xaxis_tickformat=".0%",
        xaxis_gridcolor="#f0f0f0",
        yaxis_title="Ganancia ($)", yaxis_tickprefix="$",
        yaxis_gridcolor="#f0f0f0",
        legend=dict(orientation="h", y=-0.2, x=0.0),
        margin=dict(t=60, b=20),
    )
    ...
    st.plotly_chart(fig5, use_container_width=True, config={"displayModeBar": False}, key="h3b")
...
with col5:
    ...
    st.plotly_chart(fig7, use_container_width=True, config={"displayModeBar": False}, key="h4b")
...
with col6:
    ...
    st.plotly_chart(fig8, use_container_width=True, config={"displayModeBar": False}, key="h4c")
...
with col8:
    ...
    st.plotly_chart(fig10, use_container_width=True, config={"displayModeBar": False}, key="h5b")
...
with col9:
    ...
    st.plotly_chart(fig11, use_container_width=True, config={"displayModeBar": False}, key="h5c")
